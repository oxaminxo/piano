...
const Motzart = document.querySelector(".playMotzart");
const playMotzart = () => {
    
    setTimeout(() => {
        Motzart.classList.add("disabled");
        Motzart.disabled = true;
    } , 0);
    setTimeout(() => playE5(), 250);
    setTimeout(() => playEb5(), 500);
    setTimeout(() => playE5(), 750);
    setTimeout(() => playEb5(), 1000);
    setTimeout(() => playE5(), 1250);
    setTimeout(() => playEb5(), 1500);
    setTimeout(() => playE5(), 1750);
    setTimeout(() => playB4(), 2000);
    setTimeout(() => playD5(), 2250);
    setTimeout(() => playC5(), 2500);
    setTimeout(() => playA4(), 2750);
    setTimeout(() => {
        Motzart.classList.remove("disabled");
        Motzart.disabled = false;
    } , 3000);
}

Motzart.addEventListener("click", playMotzart)